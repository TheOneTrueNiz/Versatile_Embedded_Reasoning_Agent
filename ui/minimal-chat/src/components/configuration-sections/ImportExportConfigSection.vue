...
import { shouldShowScrollButton, userText, isLoading, hasFilterText, selectedModel, isSidebarOpen, showConversationOptions, messages, streamedMessageText, modelDisplayName, localModelKey, localModelName, localModelEndpoint, localSliderValue, gptKey, sliderValue, claudeKey, claudeSliderValue, selectedDallEImageCount, selectedDallEImageResolution, selectedAutoSaveOption, browserModelSelection, maxTokens, top_P, repetitionPenalty, systemPrompt, voiceAgentVoice, uiThemeMode, uiAccentColor, uiPanelSurfacePresets, conversations, storedConversations, lastLoadedConversationId, selectedConversation, abortController, imageInput } from '@/libs/state-management/state';
...
.config-card {
    ...
    border-radius: 8px;
    overflow: hidden;
    box-shadow: 0 2px 8px var(--vera-black-10);
    ...
    &:hover {
        box-shadow: 0 4px 12px var(--vera-black-15);
    }
}
...
.action-buttons {
    ...
    .action-button {
        ...
        &:hover {
            ...
            box-shadow: 0 2px 5px var(--vera-black-10);
        }
