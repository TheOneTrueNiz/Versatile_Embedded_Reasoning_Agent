...
.webllm-config-card {
    ...
    .card-content {
        ...
        .model-selection {
            ...
            :deep(.p-listbox) {
                background-color: var(--vera-black-60);
                ...
                &:hover {
                    ...
                    box-shadow: 0 0 10px var(--vera-accent-faint);
                }
                ...
                .p-listbox-filter-container {
                    ...
                    .p-inputtext {
                        ...
                        &:focus {
                            ...
                            background-color: color-mix(in srgb, var(--vera-panel) 80%, transparent);
