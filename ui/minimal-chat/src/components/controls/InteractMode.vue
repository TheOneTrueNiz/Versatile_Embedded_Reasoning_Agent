  ...
  <div class="interact-mode" @click="toggleInteractMode">
    ...
    <div class="visualizer-container" :class="state">
      <svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
        <defs>
          <mask id="waveMask">
            <rect width="100%" height="100%" fill="var(--vera-white-95)" />
            <path :d="wavePath" fill="var(--vera-black-95)" />
          </mask>
        </defs>
...
.listening {
  --circle-visualizer-color: var(--vera-info);
}
...
.transcribing {
  --circle-visualizer-color: var(--vera-success);
}
...
.fetching {
  --circle-visualizer-color: var(--vera-warning);
}
...
.speaking {
  --circle-visualizer-color: var(--vera-accent);
}
...
.error {
  --circle-visualizer-color: var(--vera-danger);
}
