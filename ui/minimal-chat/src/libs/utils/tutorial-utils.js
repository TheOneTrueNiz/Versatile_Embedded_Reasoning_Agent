    ...
    const settingsTutorialSteps = [
        {
            popover: {
                ...
                description: 'Welcome to the VERA configuration page! Follow this short guided tour to learn about the configuration experience.'
            }
        },
        {
            element: '.right-panel',
        ...
        },
        {
            ...
            popover: {
                ...
                description: 'The general configuration option houses settings and actions that are specific to VERA.',
                side: "right",
                align: 'start'
            }
        },
...
export async function runTutortialForNewUser() {
    ...
    const mobileTutorialSteps = [
        { popover: { title: 'VERA Tutorial', description: 'Welcome to VERA! Follow this quick guided tour to learn about the app. It highlights useful information, features, and gestures!' } },
    ...
    const desktopTutorialSteps = [
        { popover: { title: 'VERA Walkthrough', description: 'Welcome to VERA! Follow this quick guided tour to learn about the app. It highlights useful information, features, and gestures!' } },
