...
def read_pdf_text(file_path: str, page_range: Optional[Dict] = None) -> Dict[str, Any]:
    """
    Extract text content from a PDF file. Use for: reading documents, getting PDF content,
    'what does this PDF say?'. Returns text per page plus combined text with word counts.
...
def extract_pdf_images(file_path: str, output_dir: Optional[str] = None, page_range: Optional[Dict] = None) -> Dict[str, Any]:
    """
    Extract all embedded images from a PDF. Use for: saving images from PDFs, getting figures/diagrams.
    Saves as PNG files. Returns paths to extracted images with dimensions and sizes.
...
def read_pdf_with_ocr(file_path: str, page_range: Optional[Dict] = None, ocr_language: str = "eng") -> Dict[str, Any]:
    """
    Extract text from PDF including OCR from images. Use for: scanned PDFs, image-heavy documents,
    when read_pdf_text misses text in images. Combines native text + OCR results.
...
def get_pdf_info(file_path: str) -> Dict[str, Any]:
    """
    Get metadata and statistics about a PDF. Use for: checking PDF before reading, getting author/title,
    counting pages/images. Returns metadata (title, author) + stats (pages, images, size).
...
def analyze_pdf_structure(file_path: str) -> Dict[str, Any]:
    """
    Detailed structural analysis of a PDF. Use for: understanding document layout, finding text vs image pages,
    checking content distribution. Returns page-by-page breakdown with content types and dimensions.
